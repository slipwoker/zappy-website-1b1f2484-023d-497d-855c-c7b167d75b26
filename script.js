    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isFormValid) {
        ...
        if (firstError) {
          ...
          const top = firstError.getBoundingClientRect().top + window.pageYOffset - navbarH - 20;
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        const newElements = node.querySelectorAll ? node.querySelectorAll(OBSERVED_SELECTORS) : [];
        if (node.matches && node.matches(OBSERVED_SELECTORS)) {
          applyScrollAnimations();
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Miral Memories משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1b1f2484-023d-497d-855c-c7b167d75b26',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1b1f2484-023d-497d-855c-c7b167d75b26';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1b1f2484-023d-497d-855c-c7b167d75b26';
